...
typedef HRESULT (WINAPI *pD3DDisassemble)(const void *data, SIZE_T data_size,
        UINT flags, const char *comments, ID3DBlob **disassembly);
// Wide string version (original Windows API)
...
// ANSI string version - used on macOS where filesystem::path::c_str() returns const char*
HRESULT WINAPI D3DCompileFromFileA(const char *filename, const D3D_SHADER_MACRO *defines, ID3DInclude *includes,
        const char *entrypoint, const char *target, UINT flags1, UINT flags2, ID3DBlob **code, ID3DBlob **errors);
#ifdef __APPLE__
// On macOS, map D3DCompileFromFile to ANSI version since std::filesystem::path uses char strings
#undef D3DCompileFromFile
#define D3DCompileFromFile D3DCompileFromFileA
#endif
